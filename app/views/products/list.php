...
.tech-grid {
    ...
    margin-top: 25px;
    list-style: none;
    /* Khử dấu chấm tròn của thẻ ul */
}

/* Biến đổi các item thành các "Card" bo mạch */
.tech-card {
    background: #1e293b !important;
    /* Nền card tối (Slate 800) */
...
.tech-image {
    ...
    /* Tối ưu kích thước linh hoạt theo khung card */
    height: 180px;
    object-fit: cover;
    border-radius: 8px;
    margin-bottom: 15px;
...
.tech-price {
    ...
    /* Xanh Cyan sáng đại diện cho năng lượng công nghệ */
    font-weight: 700;
    font-size: 1.15rem;
    margin-bottom: 10px;
}
...
.tech-actions {
    ...
    gap: 10px;
    margin-top: auto;
    /* Đẩy các nút bấm luôn nằm sát đáy card */
}
...
<div class="tech-container">
    ...
    <ul class="tech-grid">
        ...
        <li class="tech-card">
            ...
            <p class="tech-category">Danh mục:
            ...
            <div class="tech-actions">
                ...
                <a href="/webbanhang/Product/delete/<?php echo $product->id; ?>" class="btn btn-danger-tech"
                    onclick="return confirm('Bạn có chắc chắn muốn xóa sản phẩm này?');">Xóa</a>
                <?php endif; ?>
                <a href="/webbanhang/Product/addToCart/<?php echo $product->id; ?>" class="btn btn-primary">Thêm vào giỏ
                    hàng</a>
            </div>
